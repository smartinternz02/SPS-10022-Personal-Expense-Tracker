...
app.config['MYSQL_USER'] = 'a3uCPQ6y6I'
app.config['MYSQL_PASSWORD'] = 'IypzWtI0ZY'
app.config['MYSQL_DB'] = 'a3uCPQ6y6I'

app.config["MAIL_SERVER"] = 'smtp.gmail.com'
app.config['MAIL_PORT']=465
app.config['MAIL_USERNAME']="harshitarjagalur@gmail.com"
app.config['MAIL_PASSWORD']=  "02301409harshi"
